...
class Settings(BaseSettings):
    ...
    default_provider_profile: str = "gemini-first"
    ollama_base_url: str = "http://host.docker.internal:11434"
    ollama_translate_model: str = "qwen2.5:3b"
    ollama_translate_timeout_sec: float = Field(default=90.0, ge=10.0, le=300.0)
    openai_api_key: str = ""
    ...
    stt_energy_threshold: int = Field(default=1200, ge=100, le=5000)
    stt_min_speech_ms: int = Field(default=320, ge=100, le=3000)
    stt_min_voiced_ms: int = Field(default=220, ge=80, le=3000)
    stt_min_voiced_ratio: float = Field(default=0.42, ge=0.1, le=1.0)
    stt_silence_hangover_ms: int = Field(default=450, ge=150, le=3000)
